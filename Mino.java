...
public class Mino {
    ...
    boolean leftCollision, rightCollosion, bottomCollision;
    ...
    public void updateXY(int direction){
        ...
        if(leftCollision == false && rightCollosion == false & bottomCollision == false){
    ...
    public void update(){
        ...
        //all other keys handle movement
    ...
    public void deactivating(){
        ...
        //wait 45 seconds until blocks are set to static
    ...
    public void draw(Graphics2D g2){
        ...
        for(Block block : b){
            GradientPaint gradient = new GradientPaint(
                block.x, block.y, block.c.brighter(),
                block.x + Block.SIZE, block.y + Block.SIZE, block.c.darker()
            );
