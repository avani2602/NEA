...
public class GamePanel extends JPanel implements Runnable{
    ...
    public GamePanel(){
        ...
        undoButton.setBounds(900, 330, 100, 40);
        ...
        redoButton.setBounds(900, 420, 100, 40);
    ...
    public void run() {
        ...
        while(gameThread != null) {
            ...
            if(delta >= 1) {
                ...
                if (timerRunning && !gameover && !stalemate) {
    ...
    public void paintComponent(Graphics g){
        ...
        g2.setFont(new Font("Book Antiqua", Font.PLAIN, 15));
        g2.setColor(Color.WHITE);
        g2.drawString("Time: " + formatTime(currentTime), 895, 400);
        ...
        if(gameover) {
            ...
            g2.drawString("Final Time: " + formatTime(currentTime), 200, 470);
        }
        if(stalemate) {
            timerRunning = false;
            g2.setFont(new Font("Arial", Font.PLAIN, 90));
